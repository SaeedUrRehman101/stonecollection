$(document).ready(function () {
    ...
    $.ajax({
        url: "../Collections/assets/API/revolve.json",
        type: "get",
        success: function (objectdata) {
            ...
            $.each(objectdata, function (index, indexObject) {
                ...
                <div class="featured-div" data-id="${index}" data-price="${parseFloat(indexObject.para.replace('$', '').replace(/,/g, ''))}">
                    <div class="Image">
                        <a href="../Collections/revovle.html?getid=${index}"><img src="${indexObject.Image}" alt=""></a>
                    </div>
                    <a href="../Collections/revovle.html?getid=${index}" class="featured-detail" href="">
